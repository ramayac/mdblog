...
![image](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjbYy8CmiMTxB9R1YPHL4FJ_ikeohLk7s9ppWnGZvUS2XrUwfTkXuijXzJJcuenZUcifmHiaAXwCwz8CVJ7tHo6T-JUjUcnJxIYe8P5aRLxSZvQSMRbk_Y3N7gr72MIHsHbIF41_zyw0DA/s320/FriendFeed.png)    [FriendFeed](https://www.friendfeed.com) es un servicio de web 2.0 orientado a consumir feeds [(RSS, ATOM, XML, etc...)](/2008/03/que-es-el-rss-feed-rssatomxmlsyndicatio.html) de todo el contenido que la actividad en linea de un usuario produce. FriendFeed consume entradas de 43 servicios de Internet y lo condensa todo en un conveniente [río de información](/2008/08/el-r-o-de-informaci-n-reflexi-n), lo que permite que individuos como tu y yo, que pasamos horas y horas sentados en la computadora, valorando vídeos en youtube, "amando" canciones en [last.fm](/2007/03/lastfm-una-revolucin-musical.html), compartiendo artículos en el Google Reader y "twitteando" como dementes, podamos consolidar todas esas actividades en un solo feed, que podemos [compartir con amigos, grupos y usar en otras redes sociales](/2008/05/medios-sociales-sitios-web-a-lo-2-0). También puedes seguir los feeds de otros amigos, comentar en las actividades que realizan e interactuar de manera general como en cualquier sitio social conocido.
