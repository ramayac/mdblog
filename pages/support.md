...
The best way to get support or report a bug is directly on GitHub:

- **Bug Reports & Feature Requests:** Please open an issue in the respective project repository on [GitHub](https://github.com/ramayac).
- **Direct Inquiry:** If you cannot use GitHub or have a sensitive inquiry, feel free to connect via [LinkedIn](https://www.linkedin.com/in/rodrigoamaya/).
...
You can open a Feature Request issue on GitHub. If you can, describe the use case and how it benefits other users.

#### Are these apps safe and secure?
Yes. None of my applications collect, store, or sell your personal data. You can read the full [Privacy Policy](/page?slug=privacy) for more details.
