---
title: Proyecto Euler (Reto para programadores)
date: 2010-06-24
author: Rodrigo A.
tags: reto, programador
draft: false
post_id: blog-3515952828243908885.post-7109521695232727112
---

![image](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjpQ5rGDO4_PuXKzhxlhaajKpjmyEm4Lqg9hOhPYsHfDNCMAgMjnATcj6u-JnHfnyr64UhbU-LNrLaN__Q7LqMiMC-7YNj7e2P2-GQUO-G9UisGDqtlx5UQA5rh_9IB4QhpAfDCoKPC4ueG/s200/Leonhard_Euler.jpg)  
Proyecto Euler es un sitio web dedicado a los programadores que desean aprender, ejercitar su mente y que tenga un poco de tiempo libre, ofreciendo una serie de retos matemáticos, en orden de dificultad ascendente, que se pueden resolver en el lenguaje de programación que uno prefiera. Nombrado así en honor al matemático y físico Suizo: [Leonhard Euler](https://en.wikipedia.org/wiki/Leonhard_Euler) (¿recuerda el [Problema de los puentes de Königsberg](https://en.wikipedia.org/wiki/Seven_Bridges_of_K%C3%B6nigsberg) y las constantes [e](https://www.blogger.com/wiki/E_%28mathematical_constant%29) y [π](https://www.blogger.com/wiki/Pi) ?, pues es parte de la extensa obra de Euler). A la fecha, el Proyecto Euler posee 295 problemas de naturaleza matemática de dificultad variada. Existe un foro en el sitio, preguntas y respuestas que se habilitan para cada problema una vez que este está resuelto, y diferentes "niveles" para los usuarios registrado, de acuerdo a la cantidad de problemas que este a resuelto.
