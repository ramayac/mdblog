...
date: 2007-09-14
author: Rodrigo A.
tags: cifrado, descifrar, debian, hashing, encriptar, desencriptar, gcipher, md5
draft: false
...
![image](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiT1WI7bPor3th2ZEy5ABqlVV1Z1hdeeDrjjmzxJuSbIG0oWi88SFU_QiKYz012WkWlwOlPedinp5LWkvceV_N533zUdSHJAZAmnua4JpWy8XKzDxZuGFDxGQ7_tj_KfUMryo-RDUhrmD4/s320/mortal.png)  
...
El texto anterior esta encriptado con el "[código Cesar](https://es.wikipedia.org/wiki/Cifrado_C%C3%A9sar)". Este código cesar es la llave para desencriptar el texto: Se cuenta que Julio Cesar invento esta forma de encriptacion por si capturaban a un mensajero que lleva ordenes militares, los capturadores no pudieran leer el mensaje (y claro, solo los generales del Cesar tenian el conocimiento para hacerlo). ¿Y cual es este gran proceso para desencriptar el mensaje anterior? Sencillo, tomemos una letra: h, ahora nos vamos tres letras atras en el abecedario, eso nos da la letra e.

![image](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgNxYriyAJ9EhtPxhDqi1MzZfZ8AOysPBmmLlnZU_IX5RzeQwtytHnOpxATqzF-EB6W5-vm23VxqbfEV60K1rgzC79VDNjEQdbZm3WC5rkKsvBcJC-TIDK5l7QbgqTPH06tUftc1KdAbTQ/s320/320px-Caesar3.svg.png)  
...
char LetraACesar(char letra) { return System.Convert.ToChar(char.GetNumericValue(letra) + 3); }
...
![image](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgf_3N2mUkXPkkcn6hZqlixqNvV-8rI6_8YSSQMVPXuA209CJzEGbmMIHUrYQSn_5lmp5AaS4exm2DHZ9uiuZPE7OjI82GL2DzRHCzK1PgwqOfuxgz8OF0Jx5z6zkR9qqXriKQ9bCVFB9c/s320/death.png)  
"..."
