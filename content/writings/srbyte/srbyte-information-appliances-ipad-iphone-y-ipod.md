---
title: Information Appliances (iPad, iPhone y iPod)
date: 2010-01-31
author: Rodrigo A.
tags: apple, raskin, ipad, ipod, iphone
draft: false
post_id: blog-3515952828243908885.post-7089803965037200370
---
...
![image](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiWN99H32r7qAWJeLq308L0AjXW-ADZA9QZKPhULc4hiVKasPBmQOUIMo55OxkOaCJvZXjIoLBMMs_EXSFwAk1FN-jSuwZD8QWQZSyi5gDS0N4sKSgIBGdIdJg8RwgwQmaAe2R4GNfkkNGf/s320/ipad_hero_20100127.jpg)  
...
Muchos diran que el [iPad](https://www.apple.com/ipad/) es un iPhone con esteroides o glorificado. Eso pense al principio, pero ahora creo que es un poco erroneo tener esa idea de este nuevo aparatito. Veran, todos estos dispositivos, que son realmente buenos solo haciendo "una cosa a la vez" (y se mantendrán asi), son producto de un visionario diseñador llamado: [Jef Raskin](https://en.wikipedia.org/wiki/Jef_Raskin).

![image](https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Jef_Raskin_holding_Canon_Cat_model.png/450px-Jef_Raskin_holding_Canon_Cat_model.png)  

Raskin trabajo como el experto en interfaces que lidero el proyecto Macintosh (hasta que Steve Jobs lo saco de ahi). Durante su tiempo en Apple, Raskin trabajo en una IDEA de interfaz de usuario llamada "[information appliance](https://en.wikipedia.org/wiki/Information_appliance)". En la mente de Raskin, un dispositivo de información seria un "aparato con capacidades de computo con un solo propósito". Eso no suena muy interesante, pero esperen, porque Raskin propone que este aparato sea tan facil de usar que cualquier persona pueda tomarlo y comenzar a jugar con el, sin ningun tipo de entrenamiento. Hmmmm, eso me suena familiar:
...
Años mas tarde, Raskin llego a la conclusion de que si bien su idea era buena, las personas NO estarian dispuestas a usar otro aparato mas, porque ya tenian un telefono, una camara, un "walkman" o una computadora. Pero Raskin vio las "[interfaces tactiles](https://en.wikipedia.org/wiki/Multi-touch)", y llego a la conclusion de que si, quizas, los botones y la informacion estuviera todo en el software, se podría crear un "morphing information appliance". Un aparato que cambie, para hacer cada tarea (una tarea a la vez) a la perfeccion, cambiando su "modo" de acuerdo a TUS objetivos...
...
![image](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiLVoRCCesLnvtyll8wMfWQaewcxYyBD4Nypx6ZUoROVJ5BejhfTGHCmmqSa3fnTWqbB_5nZ-Z2I2OkLdZoRU5bcTkTsEHzdlknHzRErclZmGGlVcu6_VXRMV6LlcGvXnQ8GnwjUgTH-HVk/s320/multi_touch_20100127.png)  
